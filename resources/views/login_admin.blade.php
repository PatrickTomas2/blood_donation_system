    ...
    <div class="container">
        <div class="card border-0 shadow p-4">
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        <a href="{{ route('login_donor') }}">
                            <div class="card donor-custom-color border-0 shadow text-dark">
                    ...
                    <div class="col">
                        <div class="card admin-custom-color border-0 shadow text-white">
                            <div class="card-body d-flex justify-content-center align-items-center">
                ...
                <div class="text-center">
                    <h3 class="fw-bold">Admin Login Form</h3>
                </div>
